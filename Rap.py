...
def login():
    os.system('clear')
    print logo1
    print "\033[1;34m[1]\x1b[1;97mSTART WITH SOMI( \033[1;92m NOW)"
    time.sleep(0.05)
    print '\x1b[1;35m[0]\033[1;91m Exit ( Back)'
    pilih_login()
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;37m[1]  START CLONING With SOMI'
    time.sleep(0.10)
    print '\x1b[1;32m[2] SOMI FB ACCOUNT'
    time.sleep(0.10)
    print '\x1b[1;33m[3] MORE INFO'
    time.sleep(0.10)
    print '\x1b[1;34m[4] TRACKER'
    time.sleep(0.10)
    print '\x1b[1;35m[5] CLONING ERROR'
    time.sleep(0.10)
    print '\x1b[1;36m[6] SOMI FACEBOOK'
    time.sleep(0.10)
